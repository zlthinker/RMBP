...
def feature_match(image_file1, image_file2, ratio_test=True, log_file=''):
    ...
    feat = cv.xfeatures2d.SIFT_create()
    ...
    if log_file != '':
        with open(log_file, 'w') as fout:
            ...
            for m,n in matches:
                ...
                prob = 1 - ratio                # The smaller the ratio, the higher the probability
...
if __name__ == "__main__":
    ...
    feature_match(args.image1, args.image2, ratio_test=False, log_file=args.log)